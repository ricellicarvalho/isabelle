...
class EditBankAccount extends EditRecord
{
    ...
    {
        return [Action::make('importOfx')->label('Importar OFX')->schema([
            FileUpload::make('ofx')->label('Arquivo OFX')->disk('local')->directory('ofx-imports')->acceptedFileTypes(['application/x-ofx', 'application/octet-stream', 'text/plain'])->required(),
