...
use App\Filament\Portal\Widgets\PortalSolutionsWidget;
...
class Dashboard extends BaseDashboard
{
    ...
    public function getHeading(): string|HtmlString
    {
        ...
        return new HtmlString(
            ...
            .'<p style="font-size:.8125rem; color:#6b7280; margin:0;">Serviços, documentos e oportunidades para sua empresa</p>'
            .'</div>'
            .'</div>'
            .'</div>'
        );
