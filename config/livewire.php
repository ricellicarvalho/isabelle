...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Must be at least as permissive as the FileUpload field. Otherwise
        // Livewire rejects the temporary upload before Filament can validate it.
        'rules' => ['required', 'file', 'max:25600'],          // 25 MB per file.
        ...
        'max_upload_time' => 10, // Allow slower connections to finish larger uploads.
